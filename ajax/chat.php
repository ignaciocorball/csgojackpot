...
if ($steamprofile['steamid'] == '') {
    $massage = '<font color="#008000"><i>'.htmlspecialchars($massage).'</i></font>';
}
if ($steamprofile['steamid'] == '') {
    $massage = '<font color="#D2303D"><i>'.htmlspecialchars($massage).'</i></font>';
}
if ($steamprofile['steamid'] == '') {
    $massage = '<font color="#cc883c"><i>'.htmlspecialchars($massage).'</i></font>';
}
