...
ob_start();
include('money.log'); //the relative path to the debug log of the bot (this is used in /admin.php) - if you're hosting the bot on a different server than the site this will not work, so delete this line if thats the case
