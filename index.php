...
noty({
   text: 'Be sure to check out our new 1V1 Arena, 1.00$ min deposit!',
   layout: 'top',
   ...
   <div id="content">
        <div id="leftContent">
				...
				<div class="wheel">
					<div style="position:relative;width:260px;margin:auto;left:-8px;">
						...
						<div style="position:absolute;left:10px;top:10px">
							<input class="knobtimer" data-min="0" data-max="120" data-bgColor="#293036" data-fgColor="#2dc748" data-displayInput=false data-width="260" data-height="300" data-thickness=".05" value="<?=$timeleft?>">
						</div>

						<div style="position:absolute;left:30px;top:30px;z-index:10">
							<input class="knobitems" data-min="0" data-max="50" data-bgColor="#293036" data-fgColor="#2dc748" data-displayInput=false data-width="220" data-height="220" data-thickness=".15"  value="<?=$itemsnum?>">
						</div>
					...
					<div class="hashcontainer">
							...
							<a href="BOTTRADELINK" target="_blank" class="bigBTN">DEPOSIT<span>min $0.10, max 15 items, no souvenir items</span></a><?php else: ?><a href="http://csgo-tell.ru/roulette/?login"  class="bigBTN">LOGIN<span>Please Login to Deposit</span></a>	<?php endif; ?>
			            <div id="jackpotInfo">
			...
			<div id="userPartnerInfo">
				Add <font color=#ff0000><b>csgoreborn.tk</b></font> to your steam name and get <font color=#00cb26><b>5% Chance</b></font> to your win (re-log)			</div>
        </div>
        <div id="rightContent">
	 		...
	 		<?php
	 			...
	 			if($lastgameinfo=$mysql->query('SELECT * FROM `games` WHERE `id`<"'.$currentgame.'" AND `totalvalue`>0 ORDER BY `id` DESC LIMIT 1')->fetch_assoc()):
					...
					if($lastwinnerinfo=$mysql->query('SELECT * FROM `users` WHERE `steamid`="'.$lastgameinfo['winneruserid'].'"')->fetch_assoc()){
						...
						$lastwinnername=$lastwinnerinfo['name'];
					}else{
...
<div class="hhdgfbd"></div>
	<div class="kjmhgd"></div>
	 ...
	 <div class="playerBox" id="p<?=$player['userid']?>"><span class="playerName"><img style="width:50px; height:50px; border-radius:10%;" src="<?=$playerinfo['avatar']?>" alt=""/><a href="http://steamcommunity.com/profiles/<?=$player['userid']?>/" target="_blank"><?=$playerinfo['name']?></a><?=cc($player['userid'])?></span>
	...
	<?php endwhile; ?>
			...
			<div id="footer">
				...
				<a href="http://csgoreborn.tk" target="_blank">Support</a>
			</div>
        </div>
    </div>
    <div id="chat">
...
<div id="mcaht" class="left-chat" style="overflow:auto;height:90%;overflow-x:hidden;-webkit-animation: fadeIn ease-in 1;-moz-animation:fadeIn ease-in 1;animation:fadeIn ease-in 1;-webkit-animation-duration:0.5s;-moz-animation-duration:0.5s;animation-duration:0.5s;"></div>	<script>
  ...
  <center> <div id="emojis" style="z-index:1000000;"class="modalDialog" >
	<div style="width:300px;">
		<a href="#close" title="Close" class="close"><i class="fa-times" style="font: 17px &quot;FontAwesome&quot;; color: rgb(129, 129, 129); background: transparent none repeat scroll 0% 0%;"></i></a>
                    <h4 style="font-size: 37px; color: rgb(213, 205, 205); border-bottom: 1px solid rgb(165, 6, 6); padding-bottom: 5px;">Chat emoticons</h4>
					<center>
                       <p style="padding-top: 8px;"><b> <img src="../styles/images/chat/doge.png"> - <span>Doge</span></b></p><br>
                       <p style="padding-top: 8px;"><b> <img src="../styles/images/chat/fail.png"> - <span>Fail</span></b></p><br>
                       <p style="padding-top: 8px;"><b> <img src="../styles/images/chat/happy.png"> - <span>Happy</span></b></p><br>
                       ...
                       <p style="padding-top: 8px;"><b> <img src="../styles/images/chat/lol.png"> - <span>lol</span></b></p><br>
                       <p style="padding-top: 8px;"><b> <img src="../styles/images/chat/rekt.png"> - <span>Rekt</span></b></p><br>
                       <p style="padding-top: 8px;"><b> <img src="../styles/images/chat/rigged.png"> - <span>Rigged</span></b></p><br>
                       <p style="padding-top: 8px;"><b> <img src="../styles/images/chat/rip.png"> - <span>Rip</span></b></p><br>
					   <p style="padding-top: 8px;"><b> <img src="../styles/images/chat/sad.png"> - <span>Sad</span></b></p><br>
					   <p style="padding-top: 8px;"><b> <img src="../styles/images/chat/shit.png"> - <span>Shit</span></b></p><br>
					   <p style="padding-top: 8px;"><b> <img src="../styles/images/chat/snipe.png"> - <span>Snipe</span></b></p><br>
					   <p style="padding-top: 8px;"><b> <img src="../styles/images/chat/thug.png"> - <span>Thug</span></b></p><br>
 ...
 <div id="rules" class="modalDialog">
	<div style="width: 300px;">
		<a href="#close" title="Close" class="close"><i class="fa-times" style="font: 17px &quot;FontAwesome&quot;; color: rgb(129, 129, 129); background: transparent none repeat scroll 0% 0%;"></i></a>
                    <h4 style="font-size: 37px; color: rgb(213, 205, 205); border-bottom: 1px solid rgb(165, 6, 6); padding-bottom: 5px;">Chat Rules</h4><br>
					<center>
						<p style="padding-top: 8px;"><b> Only english.</b></p><br>
 ...
 <div id="congratulations" class="modalDialog">
	<div style="width: 800;">
		<a href="#close" title="Close" class="close"><i class="fa-times" style="font: 17px &quot;FontAwesome&quot;; color: rgb(129, 129, 129); background: transparent none repeat scroll 0% 0%;"></i></a>
                    <h4 style="font-size: 37px; color: rgb(213, 205, 205); border-bottom: 1px solid rgb(165, 6, 6); padding-bottom: 5px;">Congratulations</h4><br>
					<center>
						<p style="padding-top: 8px;"><b> Only english.</b></p><br>
						<p style="padding-top: 8px;"><b> No Racism.</b></p><br>
						<p style="padding-top: 8px;"><b> No Flaming.</b></p><br>
...
<div id="loading"></div>
 </body>	<script src="http://csgoreborn.tk/static/js/appb_new.js"></script>
