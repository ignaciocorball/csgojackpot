...
?>
 ...
 <div class="pagination">
    ...
    width: calc(100% - 150px);" >';
                    echo'<b><a class="HistoryUserLink" href="http://steamcommunity.com/profiles/'.$round['winneruserid'].'" target="_blank">'.antispam($winnerinfo['name']).cc($winnerinfo['steamid']).'</a></b></br>';
                    echo'<span class="HistoryWon" style="    top: 6px;
    position: relative;">Won <b>$'.myround($round['totalvalue']).'</b> with a $'.myround($deposit).' deposit ('.myround($chance).'% chance)</span></br>';
                    echo'<br>';
    ...
    float: right; position:relative; top:5px;">';
                    ...
                    echo $itemsnum.' items deposited:<br/>';
