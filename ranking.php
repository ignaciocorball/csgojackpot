...
<div class="fullWitchContent" style="overflow:auto;">
    ...
    top: -17px;
    position: relative;">'.antispam($userinfo['name']).cc($userinfo['steamid']).'</a>';
                    echo'</td>';
    ...
    top: -17px;
    right: -20px;">';
                    echo '<a href="http://steamcommunity.com/profiles/'.$player['steamid'].'">'.antispam($player['name']).cc($player['steamid']).'</a>';
                    echo'</td>';
                    echo'<td style="text-align:right;font-weight:bold;width:40%;">';
